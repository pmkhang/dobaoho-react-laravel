...
const CategoryEdit = ({ categories, category, status, message }) => {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("updateCategory", category?.id));
    };
    return (
        <AdminLayout title="Chỉnh sửa thể thoại sản phẩm">
            ...
            <form className="mt-8" onSubmit={submit}>
                ...
                <div className="flex items-center gap-4 mt-8">
                    <Selector
                        ...
                        name="parent_id"
                        optionPlaceHolder="Không có thể loại cấp trên"
