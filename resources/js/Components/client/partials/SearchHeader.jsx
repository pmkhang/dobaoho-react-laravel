        ...
        <form className="w-3/5 max-mb:hidden relative z-50" onSubmit={submit}>
            <div className="flex gap-2 max-tl:px-4">
                <input
                    type="search"
                    id="search"
                    className="block w-full p-3 text-sm text-gray-900 border-2 border-primary focus:ring-0 rounded-lg shadow-md bg-gray-50 outline-none"
                ...
                />
                <button className="flex items-center justify-center w-[55px] text-white bg-primary hover:bg-primary-darker transition-all focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 ">
